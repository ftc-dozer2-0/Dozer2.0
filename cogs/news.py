...
class News(commands.Cog):
    ...
    @guild_only()
    @app_commands.describe(channel = "Channel to add the subscription to", source = "Source to subscribe to")
    ...
    @has_permissions(manage_guild=True)
    @guild_only()
    @app_commands.describe(channel = "Channel to remove the subscription from", source = "Source to unsubscribe from")
    ...
    @guild_only()
    @app_commands.describe(channel = "Channel to get subscriptions for")
